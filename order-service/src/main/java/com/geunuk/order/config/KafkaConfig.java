package com.geunuk.order.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, OrderCreatedEvent> consumerFactory() {
        ...
        deserializer.addTrustedPackages("com.geunuk.order.kafka.producer");
        ...
        props.put(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, false); // 수동 ACK
